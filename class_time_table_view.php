...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFrom = "`class_time_table` LEFT JOIN `Faculties` as Faculties1 ON `Faculties1`.`id`=`class_time_table`.`school` LEFT JOIN `departments` as departments1 ON `departments1`.`id`=`class_time_table`.`department` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
